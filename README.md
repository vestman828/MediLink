...
| 이름 | 학번 | 담당 역할 |
|------|------|----------|
| 박은호 | 20221840 | 기획 총괄 / 발표 / Flutter UI 수정 / PPT 제작 |
| 김우석 | 20211678 | Flutter 앱 초기 전체 구현 / FCM 알림 시연 영상 제작 / PPT 제작 |
| 김현민 | 20241919 | 백엔드 API / DB 설계·쿼리 / 브랜치 관리 / GCP 배포 |
| 김민재 | 20221736 | Flutter 앱 추가 기능 및 버그 수정 (minjae2 브랜치) |
