          ...
          : _detail == null
              ...
              : ListView(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if ((_detail!['entpName'] as String?)?.isNotEmpty == true) ...[
                    ...
                    _buildSection('💊 효능·효과', _detail!['efcy'] as String?),
                    _buildSection('📋 사용법·용법', _detail!['useMethod'] as String?),
                    _buildSection('⚠️ 주의사항 (경고)', _detail!['atpnWarn'] as String?, color: Colors.orange.shade50, borderColor: Colors.orange.shade200),
                    _buildSection('🚫 주의사항', _detail!['atpn'] as String?, color: Colors.red.shade50, borderColor: Colors.red.shade200),
                    _buildSection('🔄 상호작용', _detail!['intrc'] as String?),
                    _buildSection('😷 부작용', _detail!['se'] as String?),
                    _buildSection('🏠 보관법', _detail!['deposit'] as String?),
