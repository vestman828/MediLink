...
class _GuardianHomeScreenState extends State<GuardianHomeScreen> {
  ...
  String _statusLabel(String status) {
    switch (status) {
      case 'taken': return '복약 완료';
      case 'missed': return '미복용';
      default: return '대기중';
    }
  }
        ...
        actions: [
          Builder(builder: (ctx) {
            final totalMissed = _patients.fold<int>(
              0, (sum, p) => sum + ((p['missed_count'] as int?) ?? 0),
            );
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.warning_amber_rounded, color: Colors.red, size: 26),
          ),
        ...
        children: [
          ...
          if (schedules.isEmpty)
            const Padding(
              ...
              child: Text('오늘 스케줄이 없어요', style: TextStyle(color: AppTheme.textSecondary)),
            )
          else
  ...
  Widget _buildScheduleRow(dynamic schedule) {
    ...
    final hasPhoto = status == 'taken' && authMethod == 'photo' && photoUrl.isNotEmpty;
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('사진', style: TextStyle(color: Colors.orange.shade700, fontSize: 12, fontWeight: FontWeight.w600)),
                  ],
                ),
              ),
            ),
      ...
      builder: (ctx) => Dialog(
        ...
        child: Padding(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Text('복약 인증 사진', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
